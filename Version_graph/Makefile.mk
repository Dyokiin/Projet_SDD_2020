...
INCLUDE=./lib
SRC = ./src/EasyShare.c ./src/gestion_graphique.c ./src/ressource.c ./src/user.c ./src/calendar.c
OBJ = $(SRC:.c=.o)
EXEC = EasyShare.exe
