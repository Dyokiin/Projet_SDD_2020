...
void afficher_ressources_perso(){
	...
	if(nbObj != 0){
		...
		char ressource[100];
		afficher_mes_ressources(user_a, ressource, i);
		...
		if(nbObj != 1){
			...
			for(i = 1;i<nbObj; i++){
				...
				char texte[100];
				afficher_mes_ressources(user_a, texte, i);
...
void afficher_ressources(){
	...
	if(nbObj != 0){
		...
		char ressource[100];
		renvoyer_ressource_type(user_a, type, i, ressource);
		...
		if(nbObj != 1){
			...
			for(i = 1;i<nbObj; i++){
				...
				char texte[100];
				renvoyer_ressource_type(user_a, type, i, texte);
...
void on_valider_emprunter(GtkWidget *pBtn, gpointer data) {
	...
	emprunter_ressource_type(user_a, type, i);
